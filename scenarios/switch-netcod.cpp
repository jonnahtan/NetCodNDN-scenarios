...
main(int argc, char* argv[])
{
	...
	// Adding routers
	routers.Add("Basel");
	routers.Add("Neuchatel");
	routers.Add("Zurich-University");
	routers.Add("Delemont");
	routers.Add("Kreuzlingen");
	routers.Add("Grenchen");
	routers.Add("Fribourg");
	routers.Add("Geneva");
	routers.Add("Birmensdorf");
	routers.Add("Chur");
	routers.Add("Brugg");
	routers.Add("Lausanne-University");
	routers.Add("Villigen-PSI");
	routers.Add("Bern");
	routers.Add("Winterthur");
	routers.Add("Davos");
	routers.Add("Martigny");
	routers.Add("Zurich-ETH");
	routers.Add("Lausanne-EPFL");
	routers.Add("Rapperswil");
	routers.Add("Liechtenstein");
	routers.Add("IXEurope-Zurich");
	routers.Add("Buchs-SG");
	routers.Add("St-Gallen");
	routers.Add("CERN");
	routers.Add("Yverdon");
	routers.Add("Manno");
	routers.Add("Rueschlikon");
	routers.Add("Horw");
	routers.Add("Brig");
	...
	{
		p2p.Install(client, routers.Get(rand() % routers.size()));
		p2p.Install(client, routers.Get(rand() % routers.size()));
	}
	...
	StrategyChoiceHelper::Install<nfd::fw::RandomLoadBalancerStrategy>(routers, "/unibe");
	...
	sourceConsumerHelper.SetAttribute("MaxSeq", StringValue("120"));
	...
	clientHelper.SetAttribute("Window", StringValue("15"));
	...
	{
		fileName = "results/switch-netcod/app-delays-trace-";
