...
main(int argc, char* argv[])
{
	...
	//Install NDN stack in nodes
	ndnHelper.InstallAll();

	// Choosing forwarding strategy
	StrategyChoiceHelper::Install<nfd::fw::WeightedLoadBalancerStrategy>(NodeContainer::GetGlobal(), "/unibe");
	...
	// Consumer(s)
	AppHelper clientHelper("ns3::ndn::FileConsumerCbr");
	...
	// Producer(s)
 	AppHelper producerHelper("ns3::ndn::FakeFileServer");
