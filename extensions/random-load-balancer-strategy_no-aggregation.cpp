...
NFD_LOG_INIT("RandomLoadBalancerStrategy_NA");

namespace nfd {
namespace fw {

const Name RandomLoadBalancerStrategy_NA::STRATEGY_NAME("ndn:/localhost/nfd/strategy/random-load-balancer-no-aggregation");
...
void
RandomLoadBalancerStrategy_NA::afterReceiveInterest(const Face& inFace, const Interest& interest,
                                                                ...
                                                                shared_ptr<ncft::Entry> ncftEntry)
{
  ...
  // No Aggregation in this strategy
