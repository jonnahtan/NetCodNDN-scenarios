...
for i in range(N_RUN):
    ...
    data_packets_ncn = pd.concat([data_packets_ncn, read_data_packets_at_source ( '../../results/generated/' + str(i+1) + '/netcodndn/l3-rate-trace-ton.txt' )], axis=1, ignore_index=True)
    data_packets_ndn = pd.concat([data_packets_ndn, read_data_packets_at_source ( '../../results/generated/' + str(i+1) + '/netcodndn/l3-rate-trace-all.txt' )], axis=1, ignore_index=True)
